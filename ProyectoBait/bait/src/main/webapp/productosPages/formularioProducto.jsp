<form method="post" action="actionProducto.jsp">
    ...
    Descripcion: <textarea id="descripcion" name="descripcion" rows="4" cols="50">Descripcion del producto</textarea><br>  
    Stock: <input type="text" name="categoria" placeholder="19"><br>    
